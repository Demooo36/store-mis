...
export type ProductStockWhereInput = {
  ...
  storeId?: Prisma.StringFilter<"ProductStock"> | string
  ProductId?: Prisma.StringFilter<"ProductStock"> | string
  onHand?: Prisma.IntFilter<"ProductStock"> | number
}
...
export type ProductStockScalarWhereWithAggregatesInput = {
  ...
  storeId?: Prisma.StringWithAggregatesFilter<"ProductStock"> | string
  ProductId?: Prisma.StringWithAggregatesFilter<"ProductStock"> | string
  onHand?: Prisma.IntWithAggregatesFilter<"ProductStock"> | number
}
...
export type ProductStockOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"storeId" | "ProductId" | "onHand", ExtArgs["result"]["productStock"]>
...
export interface ProductStockDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const productStockWithStoreIdOnly = await prisma.productStock.findMany({ select: { storeId: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many ProductStocks and only return the `storeId`
   * const productStockWithStoreIdOnly = await prisma.productStock.createManyAndReturn({
   *   select: { storeId: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more ProductStocks and only return the `storeId`
   * const productStockWithStoreIdOnly = await prisma.productStock.updateManyAndReturn({
   *   select: { storeId: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ProductStockFieldRefs {
  readonly storeId: Prisma.FieldRef<"ProductStock", 'String'>
  readonly ProductId: Prisma.FieldRef<"ProductStock", 'String'>
  readonly onHand: Prisma.FieldRef<"ProductStock", 'Int'>
}
